                    ...
                    {!user && (
                        <>
                            <p className="px-6 text-[11px] leading-relaxed">
                                By signing in, you agree to our <Link href="/terms" className="text-foreground hover:underline font-bold">Terms of Service</Link> and <Link href="/privacy" className="text-foreground hover:underline font-bold">Privacy Policy</Link>.
                            </p>
